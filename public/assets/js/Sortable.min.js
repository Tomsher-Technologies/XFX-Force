    ...
    ((Bt.prototype = {
            ...
            if (e.cancelable) {
                ...
                if (
                    ...
                    !q &&
                        ...
                        !(
                            ((l = N(l, t.draggable, o, !1)) && l.animated) ||
                            J === l
                        ))
                ) {
                    if (
            ...
            function O(t) {
                return (
                    ...
                    e.dragoverBubble ||
                        n.rootEl ||
                        l === document ||
                        (q.parentNode[j]._isOutsideThisEl(n.target),
                        t || Xt(n)),
                    !e.dragoverBubble &&
                        n.stopPropagation &&
                        n.stopPropagation(),
                ...
                Bt.eventCanceled ||
                    ...
                    t &&
                        ...
                        q &&
                            ...
                            pt &&
                                !yt &&
                                I(q, (lt || this).options.ghostClass, !1),
        ...
        (Bt.mount = function () {
            ...
            (e = e[0].constructor === Array ? e[0] : e).forEach(function (t) {
                ...
                (t.utils && (Bt.utils = M(M({}, Bt.utils), t.utils)),
                    K.mount(t));
            });
        }),
                        ...
                        (0 == T && 0 == p) ||
                            ...
                            (Zt[d].pid = setInterval(
                                function () {
                                    o &&
                                        0 === this.layer &&
                                        Bt.active._onTouchMove(qt);
                                    var t = Zt[this.layer].vy
                                            ? Zt[this.layer].vy * s
                                            : 0,
                                        e = Zt[this.layer].vx
                                            ? Zt[this.layer].vx * s
