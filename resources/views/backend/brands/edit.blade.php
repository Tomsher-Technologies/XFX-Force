                ...
                <form class="form-horizontal" action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="repeater" id="brand-sections-repeater">
                        <div data-repeater-list="sections">
                           @include('backend.brands.partials.brand-details' ,['brand' => $brand])
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <textarea name="meta_description" class="form-control" data-min-height="200">{{ old('meta_description', $brand->getTranslation('meta_description', $lang)) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <textarea name="og_description" class="form-control" data-min-height="200">{{ old('og_description', $brand->getTranslation('og_description', $lang)) }}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="col-form-label" for="name">{{trans('messages.twitter_description')}}</label>
                            <textarea name="twitter_description" class="form-control" data-min-height="200">{{ old('twitter_description', $brand->getTranslation('twitter_description', $lang)) }}</textarea>
                        </div>
                    </div>
