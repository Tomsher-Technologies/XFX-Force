...
<section class="px-[16px] md:px-[140px] pt-[80px] md:pt-[150px] pb-[0px] relative">
    <!-- <div class="section-title mb-[0px] relative border-t-1 border-[#282B34] pt-[50px] flex flex-col gap-[30px] "> -->
        ...
        <h3 class="text-[40px] md:text-[50px] text-white capitalize font-bold text-center uppercase flex flex-col md:flex-row flex-start justify-center md:justify-start items-center md:items-start gap-[0px] md:gap-[10px] m-0 leading-[30px] md:leading-[60px]">Checkout</h3>
        <a href="{{ route('cart') }}" class="border border-white/10 text-white text-center px-5 py-5 rounded-2xl font-medium uppercase text-[13px] hover:bg-white/5 transition-all">
                                Back to Cart
        </a>
    </div>
</section>
