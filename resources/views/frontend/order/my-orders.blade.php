                ...
                <main class="flex-grow xl:pb-0">
                    <div>
                        <div class="flex flex-col md:flex-row justify-between items-end mb-10 pb-[30px] gap-4 border-b border-[#252B31] text-center md:text-left">
                            <div class="w-full">
                                <h2 class="text-[20px] font-medium mb-1 text-white uppercase">Order History</h2>
                            ...
                            <div class="order-item bg-[#1C2228] border border-[#282B34] rounded-2xl overflow-hidden group {{ $class }}">
                                <div class="p-6 flex flex-col md:flex-row justify-between items-center gap-6">
                                    <div class="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
                                        <div>
                                            <span class="order-code text-white text-[18px] font-medium uppercase block"># {{ $order->code }}</span>
                                    ...
                                    <div class="flex flex-col items-center md:items-start gap-2">
                                        ...
                                        <div class="price w-full flex flex-row items-center gap-[10px]">
                                            <h5 class="price flex flex-row text-white text-left text-[18px] m-[0] font-medium align-center items-center gap-[10px]">
                                                <svg class="w-[18px]" width="18" height="18" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
