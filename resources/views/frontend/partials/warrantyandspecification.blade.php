...
@endphp
<div class="spec-modal-overlay fixed top-0 left-0 w-full h-full inset-0 z-[9999] hidden overflow-y-auto bg-black/80 backdrop-blur-md transition-all duration-300 opacity-0 px-4 py-10">
    <div class="spec-modal-container relative mx-auto bg-[#0B0F13] border border-gray-800 w-full max-w-4xl rounded-2xl shadow-2xl transform scale-100 transition-all duration-300 mt-[100px]">
        ...
        <div class="px-8 pb-10 text-gray-300">
            <h2 class="text-[18px] md:text-[20px] uppercase font-bold text-white pb-[20px] border-b-2 border-[#2A7CFF]">
                Specifications</h2>
                        ...
                        <div class="space-y-4">
                            ...
                            <label onclick="selectWarranty(this)" class="warranty-card relative flex items-center justify-between p-5 rounded-xl cursor-pointer transition-all duration-200 {{ $item->warranty_id == $warranty->id
                                ...
                                <div class="flex items-center gap-4">
                                    <svg class="{{$warranty->price > 0 ? '' : 'hidden'}}" width="15px" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 13" role="img" aria-label="Symbol of AED">
