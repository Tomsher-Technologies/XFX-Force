<section aria-labelledby="products-heading" class="pb-0 pt-[15px] xl:pt-6" id="product-list-wrapper">
    ...
    <div class="flex flex-col gap-[15px]">
        @foreach ($products as $product)
            ...
            <div class="product-card-list flex flex-row md:grid md:grid-cols-4 overflow-hidden bg-black/30 backdrop-blur-[60px] rounded-[10px] transition-all hover:bg-black/40"
