<div class="flex flex-row justify-between items-center p-[20px] md:p-[30px] border-b border-[#2E363E] flex-shrink-0">
    <div>
        <h2 class="text-white text-[20px] md:text-[25px] leading-[30px] font-bold">Details</h2>
...
<div class="flex-grow overflow-y-auto p-[20px] md:p-[30px] no-scrollbar">
    <div class="flex flex-col w-full">
        ...
        <div class="bg-[#252B31] rounded-[20px] p-4 mb-6 flex justify-center items-center">
            <img id="details-img" src="{{$image}}" alt="" title="" class="max-h-48 object-contain">
        </div>
    ...
    <div class="w-full">
        ...
        <div class="price w-full flex flex-row items-end gap-[15px]">
            <h5 class="flex flex-row text-white text-left text-[20px] m-[0] font-bold items-center gap-[10px] leading-[35px]">
                ...
                <span id="details-price" class="text-white text-left text-[20px] font-bold leading-[35px]">{{ number_format($stock?->offer_price, 2) }}</span>
            </h5>
        </div>
    </div>
