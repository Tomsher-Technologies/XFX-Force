                ...
                <main>
                    <div>
                        <div class="section-title mb-10 relative border-t-1 border-[#ffffff30] pt-[50px]">
                            <h1 class="w-full text-[40px] md:text-[50px] text-white capitalize font-bold text-center uppercase flex flex-col md:flex-row flex-start justify-center lg:justify-start items-center md:items-start gap-[0px] md:gap-[10px] m-0 leading-[30px] md:leading-[60px]">
                                {{ $page_content['title'] ?? '' }}
                            </h1>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                            ...
                            <div class="lg:col-span-5 space-y-12">
                                ...
                                <div class="space-y-3 md:space-y-6">
                                    <div class="flex items-start gap-6 1C2228 border border-white/8 p-8 rounded-3xl group hover:border-[#2A7CFF]/30 transition-all">
                                        <div class="w-12 h-12 rounded-2xl bg-[#2A7CFF]/10 flex items-center justify-center text-[#2A7CFF] flex-shrink-0">
                                    ...
                                    <div class="flex items-start gap-6 border border-white/8 p-8 rounded-3xl group hover:border-[#2A7CFF]/30 transition-all">
                                        <div class="w-12 h-12 rounded-2xl bg-[#2A7CFF]/10 flex items-center justify-center text-[#2A7CFF] flex-shrink-0">
                            ...
                            <div class="lg:col-span-7">
                                <div class="bg-[#1C2228] backdrop-blur-md border border-white/10 p-8 md:p-10 rounded-[20px]">
                                    ...
                                    <form id="pc-contact-form" class="space-y-6" action="{{ route('contact.submit') }}" method="POST">
                                        ...
                                        <button type="submit" class="w-full bg-[#2A7CFF] text-white py-4 rounded-[10px] font-medium uppercase text-[13px] cursor-pointer hover:bg-white hover:text-black transition-all">
                                            Submit
                                        </button>
