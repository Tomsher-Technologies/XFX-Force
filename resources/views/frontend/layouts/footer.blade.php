    ...
    <ul class="flex justify-between items-center">
        ...
        <li>
            <a href="{{ route('cart') }}" class="flex flex-col items-center gap-1 text-gray-400 hover:text-[#2A7CFF] transition-colors relative">
                <span class="count bg-[#2a7cff] text-white text-[10px] font-bold h-5 w-5 inline-flex leading-[25px] p-[5px] items-center justify-center rounded-full absolute -top-1 -right-1 border-2 border-transparent">10</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
