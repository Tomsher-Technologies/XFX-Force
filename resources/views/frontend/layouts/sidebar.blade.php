<aside class="w-full xl:w-80 flex-shrink-0 fixed left-0 px-4 z-[100] xl:relative xl:bottom-0 xl:px-0 xl:z-0">
    <div class="bg-[#212328] xl:bg-[#1C2228] border border-[#282B34] p-[5px] rounded-[15px] xl:rounded-[20px] xl:p-6 xl:sticky xl:top-[180px] shadow-2xl">
        ...
        <nav class="flex flex-row xl:flex-col gap-0 xl:space-y-0">
            
            <a href="{{ route('account') }}" class="w-full flex flex-col xl:flex-row items-center xl:items-start gap-1 xl:gap-4 p-[10px] xl:p-3 rounded-[10px]  transition-all group  {{ request()->routeIs('account*') ? 'bg-[linear-gradient(52deg,_#0844ff_11.5%,_#64b8fb_129.52%)] text-white font-medium' : 'hover:bg-[#252C33] text-[#898989] text-gray-400 hover:text-white' }} ">
            ...
            <a href="{{ route('orders.index') }}" class="w-full flex flex-col xl:flex-row items-center xl:items-start gap-1 xl:gap-4 p-[10px] xl:p-3 rounded-[10px]  transition-all group {{ request()->routeIs('order*') ? 'bg-[linear-gradient(52deg,_#0844ff_11.5%,_#64b8fb_129.52%)] text-white font-medium' : 'hover:bg-[#252C33] text-[#898989] text-gray-400 hover:text-white' }} ">
            ...
            <a href="{{ route('my-address') }}" class="w-full flex flex-col xl:flex-row items-center xl:items-start gap-1 xl:gap-4 p-[10px] xl:p-3 rounded-[10px]  transition-all group  {{ request()->routeIs('my-address*') ? 'bg-[linear-gradient(52deg,_#0844ff_11.5%,_#64b8fb_129.52%)] text-white font-medium' : 'hover:bg-[#252C33] text-[#898989] text-gray-400 hover:text-white' }} ">
            ...
            <a href="{{ route('wishlist') }}" class="w-full flex flex-col xl:flex-row items-center xl:items-start gap-1 xl:gap-4 p-[10px] xl:p-3 rounded-[10px]  transition-all group {{ request()->routeIs('wishlist*') ? 'bg-[linear-gradient(52deg,_#0844ff_11.5%,_#64b8fb_129.52%)] text-white font-medium' : 'hover:bg-[#252C33] text-[#898989] text-gray-400 hover:text-white' }} ">
            ...
            <a href="{{ route('update-password') }}" class="w-full flex flex-col xl:flex-row items-center xl:items-start gap-1 xl:gap-4 p-[10px] xl:p-3 rounded-[10px]  transition-all group  {{ request()->routeIs('update-password*') ? 'bg-[linear-gradient(52deg,_#0844ff_11.5%,_#64b8fb_129.52%)] text-white font-medium' : 'hover:bg-[#252C33] text-[#898989] text-gray-400 hover:text-white' }} ">
            ...
            <a href="{{ route('customer.notifications') }}" class="w-full flex flex-col xl:flex-row items-center xl:items-start gap-1 xl:gap-4 p-[10px] xl:p-3 rounded-[10px]  transition-all group  {{ request()->routeIs('customer.notifications*') ? 'bg-[linear-gradient(52deg,_#0844ff_11.5%,_#64b8fb_129.52%)] text-white font-medium' : 'hover:bg-[#252C33] text-[#898989] text-gray-400 hover:text-white' }}  ">
                <svg class="w-5 h-5 group-hover:text-white  {{ request()->routeIs('customer.notifications*') ? 'text-[#ffffff]' : 'text-[#898989]' }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#9F9FA9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <span class="text-[10px] lg:text-[15px]">Notifications</span>
            </a>
